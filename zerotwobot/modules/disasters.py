...
TIGERLIST_HANDLER = CommandHandler(["tigers", "listymods"], tigerlist, run_async=True)
SUPPORTLIST_HANDLER = CommandHandler(["supportlist", "demons", "listxmods"], supportlist, run_async=True)
